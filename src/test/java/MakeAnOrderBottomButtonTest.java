...
public class MakeAnOrderBottomButtonTest {
    WebDriver driver;
    String[] orderData;

    public MakeAnOrderBottomButtonTest(String metro, String name, String surname, String adress, String phone, String comment,
...
//            driver = new ChromeDriver();
    ...
    public void orderFlowTestOrderButton1() {
        ...
        homePageLocators.scrollPageTillOrderBottomButton();
        // нажимаем кнопку "Заказать" внизу главной страницы
        homePageLocators.clickOrderBottomButton();
